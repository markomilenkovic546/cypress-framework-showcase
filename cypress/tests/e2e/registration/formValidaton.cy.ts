    ...
    context('Desktop viewport', { tags: ['@desktop'] }, () => {
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the First Name');
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Last Name');
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Occupation');
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Location');
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Image');
                authPage.registrationForm.fillRegistrationForm(user, {
                    hasImage: false
                });
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Email');
                delete user.email;
                authPage.registrationForm.fillRegistrationForm(user, {
                    hasImage: true
                });
        ...
        it(
            ...
            () => {
                ...
                cy.section('Provide all inputs except the Password');
